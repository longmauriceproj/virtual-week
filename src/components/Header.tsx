      ...
      >
        <div className="flex lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5">
            <span className="sr-only">Virtual Week</span>
            <p className="text-lg font-semibold text-zinc-100">Virtual Week</p>
            {/* <Image src={logo} alt="Virtual Week" width={60} height={60} /> */}
          </a>
        </div>
